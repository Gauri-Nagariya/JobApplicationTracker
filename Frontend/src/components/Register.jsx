...
const Register = () => {
  ...
  >
    <div className="glass flex flex-col md:flex-row items-center">
      ...
      <div className="min-h-screen w-full md:w-screen flex items-center justify-center">
        <div className="w-full max-w-md px-6 md:px-10 py-12">
          ...
          >
            ...
            <Form.Item>
              <Button
                htmlType="submit"
                className="!h-10 !w-full !border !border-white/50 !text-white/90 !text-xl !font-bold !rounded-md !bg-black !hover:bg-white/50"
              >
                Submit
              </Button>
            </Form.Item>
