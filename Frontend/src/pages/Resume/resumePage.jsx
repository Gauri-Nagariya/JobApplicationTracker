    ...
    },
    {
      ...
      content: analysis && (
        <div className="flex flex-col items-center px-4 space-y-6">
          ...
          <Card
            title="Hard Skills"
            className="w-full md:w-159 bg-gray-800 text-white md:!mb-0 !mb-2 rounded-lg shadow-md"
          >
          ...
          <Card
            title="Soft Skills"
            className="w-full md:w-159 bg-gray-800 text-white rounded-lg shadow-md  md:!mb-0 !mb-2"
          >
            <p className="font-semibold">Matched:</p>
            <Space wrap>
              {analysis.softSkills.matched.length ? (
          ...
          <Card
            ...
            className="w-full md:w-159 bg-gray-800 text-white rounded-lg shadow-md"
          >
            {analysis.missingSections.length ? (
              analysis.missingSections.map((section) => (
