...
const ApplicationsForm = () => {
  ...
  const SalaryRangeInput = () => (
    <Space>
      <Form.Item
        ...
        rules={[{ required: true, message: "Enter min salary" }]}
      >
        <InputNumber placeholder="Min Salary" min={0} style={{ width: 120 }} />
      </Form.Item>
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: "Enter max salary" }]}
      >
        <InputNumber placeholder="Max Salary" min={0} style={{ width: 120 }} />
      </Form.Item>
    </Space>
  );
  ...
  return (
    <div
      ...
      // style={{ backgroundImage: `url(${bgDashboard})` }}
    >
      <div className="md:p-30 p-2 md:pt-6 pt-2 h-auto w-full flex flex-col">
        <h1 className="text-center md:text-3xl text-xl md:font-bold font-semibold md:tracking-widest text-white md:mb-8 mb-6 md:pt-4 pt-4">
          {id ? "EDIT YOUR APPLICATION" : "ADD YOUR APPLICATION"}
        </h1>
        <div className="flex md:flex-row flex-col md:border md:p-12 p-2 h-auto justify-between gap-8 rounded-4xl ">
          <div className="md:w-screen">
            <Form
              ...
              autoComplete="off"
            >
              <div className="md:flex !pr-4 md:gap-8">
                {/* left div  */}
                <div className="md:w-fit md:pr-40">
                  <Form.Item
                    label="Company Name"
                    name="companyName"
                    rules={[
                ...
                <div className="w-fit">
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="ant-upload-text hidden md:flex md:justify-center">
                        Click or drag file to this area to upload
                      </p>
                      <p className="ant-upload-hint">
                        Only PDF/Word files.
